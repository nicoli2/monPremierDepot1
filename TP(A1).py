...
if prix > 0:
    print(modepayment)
    mode = saisirCorect("Choisissez une mode  de payment ", "1,2,3,Q")
    print("---------------------------------------------------")
    print("***************************************************")
    if mode != "Q":
        modepaym = typef(mode, "Espece", "Carte  de credit", "Carte  de debit", "")
        print("*******              TITRE STM            *********")
        print("*                                                 *")
        print("*      Type :   ", type)
        print("*      Tarif :   ", tar)
        print("*      Mode de payment :  ", modepaym)
        print("*")
        print("*      Prix avant taxes : ", "%.2f" % (prix * 0.85), " $ ")
        print("*      TPS              : ", "%.2f" % (prix * 0.05), " $ ")
        print("*      TVQ              : ", "%.2f" % (prix * 0.10), " $ ")
        print("*      Prix a payer     : ", "%.2f" % prix ," $ ")
        print("")
        print("***************************************************")
elif prix == 0:
    print("---------------------------------------------------")
